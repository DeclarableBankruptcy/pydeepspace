...
class Vision:
    def __init__(self):
        ...
        self.ground_tape_error_value_x = 999
        self.ground_tape_error_value_y = 999
        self.ground_tape_error_value_angle = 999
    ...
    def new_ground_value_x(self, entry, key, value, param):
        # self.time = time.monotonic()
        self.target_tape_error_value = value
