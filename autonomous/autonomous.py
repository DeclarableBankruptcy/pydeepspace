...
class LeftStartAuto(AutonomousStateMachine):
    ...
    def drive_to_side_cargo_bay(self):
        ...
        if self.side_cargoship_stage == 1:
            self.chassis.set_inputs(
                self.side_cargoship_x_1,
                self.side_cargoship_y_1,
                self.side_cargoship_spin_1,
            )
            if (
                self.navx.getAngle() >= math.pi * 1.5
            ):  # might be wrong depending on wat side the hatch is on
                self.chassis.set_inputs(
                    self.side_cargoship_x_1, self.side_cargoship_y_1, 0
                )
                self.side_cargoship_spin_1 = 0
            if self.chassis.odometry_x > 6.5:
                self.chassis.set_inputs(
                    0, self.side_cargoship_y_1, self.side_cargoship_spin_1
                )
                self.side_cargoship_x_1 = 0
            if self.chassis.odometry_y > 2.4:
                self.chassis.set_inputs(
                    self.side_cargoship_x_1, 0, self.side_cargoship_spin_1
                )
                self.side_cargoship_y_1 = 0
            if (
                self.side_cargoship_x_1 == 0
                and self.side_cargoship_y_1 == 0
                and self.side_cargoship_spin_1 == 0
            ):
                self.side_cargoship_stage += 1
                self.next_state_now("align_for_deployment")
                # second pass
        if self.side_cargoship_stage == 2:
            self.chassis.set_inputs(
                self.side_cargoship_x_2,
                self.side_cargoship_y_2,
                self.side_cargoship_spin_2,
            )
            if (
                self.navx.getAngle() >= math.pi * 1.5
            ):  # might be wrong depending on wat side the hatch is on
                self.chassis.set_inputs(
                    self.side_cargoship_x_2, self.side_cargoship_y_2, 0
                )
                self.side_cargoship_spin_2 = 0
            if self.chassis.odometry_x > 6.5:
                self.chassis.set_inputs(
                    0, self.side_cargoship_y_2, self.side_cargoship_spin_2
                )
                self.side_cargoship_x_2 = 0
            if self.chassis.odometry_y > 2.4:
                self.chassis.set_inputs(
                    self.side_cargoship_x_2, 0, self.side_cargoship_spin_2
                )
                self.side_cargoship_y_2 = 0
            if (
                self.side_cargoship_x_2 == 0
                and self.side_cargoship_y_2 == 0
                and self.side_cargoship_spin_2 == 0
            ):
                self.side_cargoship_stage += 1
                self.next_state_now("align_for_deployment")
                # third pass
        if self.side_cargoship_stage == 3:
            self.chassis.set_inputs(
                self.side_cargoship_x_3,
                self.side_cargoship_y_3,
                self.side_cargoship_spin_3,
            )
            if (
                self.navx.getAngle() >= math.pi * 1.5
            ):  # might be wrong depending on wat side the hatch is on
                self.chassis.set_inputs(
                    self.side_cargoship_x_3, self.side_cargoship_y_3, 0
                )
                self.side_cargoship_spin_3 = 0
            if self.chassis.odometry_x > 6.5:
                self.chassis.set_inputs(
                    0, self.side_cargoship_y_3, self.side_cargoship_spin_3
                )
                self.side_cargoship_x_3 = 0
            if self.chassis.odometry_y > 2.4:
                self.chassis.set_inputs(
                    self.side_cargoship_x_3, 0, self.side_cargoship_spin_3
                )
                self.side_cargoship_y_3 = 0
            if (
                self.side_cargoship_x_3 == 0
                and self.side_cargoship_y_3 == 0
                and self.side_cargoship_spin_3 == 0
            ):
                self.side_cargoship_stage += 1
                self.next_state_now("align_for_deployment")
    ...
    def drive_to_loading_bay(self):
        ...
        if self.loading_bay_stage == 1:
            ...
            self.chassis.set_inputs(
                self.loading_bay_x_2, self.loading_bay_y_2, self.loading_bay_spin_2
            )
            if (
                self.navx.getAngle() >= math.pi
            ):  # might be wrong depending on wat side the hatch is on
            ...
            if self.chassis.odometry_x < -6.5:
                self.chassis.set_inputs(
                    0, self.loading_bay_y_2, self.loading_bay_spin_2
                )
            ...
            if (
                self.loading_bay_x_2 == 0
                and self.loading_bay_y_2 == 0
                and loading_bay_spin_2 == 0
            ):
                self.loading_bay_stage += 1
                self.next_state_now("align_for_intake")
            ...
            self.chassis.set_inputs(
                self.loading_bay_x_3, self.loading_bay_y_3, self.loading_bay_spin_3
            )
            if (
                self.navx.getAngle() >= math.pi
            ):  # might be wrong depending on wat side the hatch is on
            ...
            if self.chassis.odometry_x < -6.5:
                self.chassis.set_inputs(
                    0, self.loading_bay_y_3, self.loading_bay_spin_3
                )
            ...
            if (
                self.loading_bay_x_3 == 0
                and self.loading_bay_y_3 == 0
                and self.loading_bay_spin_3 == 0
            ):
                self.loading_bay_stage += 1
                self.next_state_now("align_for_intake")
            ...
            self.chassis.set_inputs(
                self.loading_bay_x_4, self.loading_bay_y_4, self.loading_bay_spin_4
            )
            if (
                self.navx.getAngle() >= math.pi
            ):  # might be wrong depending on wat side the hatch is on
            ...
            if self.chassis.odometry_x < -6.5:
                self.chassis.set_inputs(
                    0, self.loading_bay_y_4, self.loading_bay_spin_4
                )
            ...
            if (
                self.loading_bay_x_4 == 0
                and self.loading_bay_y_4 == 0
                and self.loading_bay_spin_4 == 0
            ):
                self.loading_bay_stage += 1
                self.next_state_now("align_for_intake")
...
class RightStartAuto(LeftStartAuto):
    ...
    def drive_to_side_cargo_bay(self):
        ...
        if self.side_cargoship_stage == 1:
            ...
            if (
                self.navx.getAngle() >= math.pi * 0.5
            ):  # might be wrong depending on wat side the hatch is on
                self.chassis.set_inputs(
                    self.side_cargoship_x_1, self.side_cargoship_y_1, 0
                )
